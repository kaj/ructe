...
fn test_hello_args() {
    assert_eq!(
        r2s(|o| templates::hello_args_html(o, "World")),
        "<h1>Hello World!</h1>\n",
    );
}
...
fn test_hello_encodes_args() {
    assert_eq!(
        r2s(|o| templates::hello_args_html(o, "encoded < & >")),
        "<h1>Hello encoded &lt; &amp; &gt;!</h1>\n"
    );
}
...
fn test_hello_args_two() {
    assert_eq!(
        r2s(|o| templates::hello_args_two_html(o, 56, "prime", false)),
...
fn test_hello_args_three() {
    assert_eq!(
        r2s(|o| templates::hello_args_three_html(o, 56, &56, &56)),
        "<p>56 56 56</p>\n"
    );
}
...
fn test_if_let_some() {
    assert_eq!(
        r2s(|o| templates::if_let_html(o, Some("thing"))),
...
fn test_if_let_none() {
    assert_eq!(
        r2s(|o| templates::if_let_html(o, None)),
        "<p> Got nothing </p>\n"
    )
}
...
fn test_if_let_destructure() {
    assert_eq!(
        r2s(|o| templates::if_let_destructure_html(o, &Some((47, 11)))),
...
#[test]
fn test_if_else_if() {
    let f = |n| r2s(|o| templates::if_else_if_html(o, n));
...
fn test_list() {
    assert_eq!(
        r2s(|o| templates::list_html(o, &["foo", "bar"])),
        "\n<ul>\n  \n    <li>foo</li>\n  \n    <li>bar</li>\n  \n</ul>\n\n"
    );
}
...
fn test_list_destructure() {
    assert_eq!(
        r2s(|o| templates::list_destructure_html(o, &["foo", "bar"])),
        "<ul>\n  \n    <li>0: foo</li>\n  \n    \
         <li>1: bar</li>\n  \n</ul>\n"
    );
}
...
fn test_list_destructure_2() {
    assert_eq!(
        r2s(|o| templates::list_destructure_2_html(o)),
...
fn test_uselist() {
    assert_eq!(
        r2s(|o| templates::uselist_html(o)),
        "<h1>Two items</h1>\n\n\
         <ul>\n  \n    <li>foo</li>\n  \
         \n    <li>bar</li>\n  \n</ul>\n\n\n\
         <h2>No items</h2>\n\n\
...
fn test_hello_utf8() {
    assert_eq!(
        r2s(|o| templates::hello_utf8_html(o, "δ", "ε", "δ < ε", "δ &lt; ε")),
        "<p>δ &lt; ε</p>\n\
         <p>δ &lt; ε</p>\n\
         <p>δ &lt; ε</p>\n\
         <p>δ &lt; ε</p>\n"
...
fn test_comments() {
    assert_eq!(
        r2s(|o| templates::comments_html(o)),
...
fn test_hello_fields() {
    ...
    assert_eq!(
        r2s(|o| templates::hello_fields_html(o, &user)),
...
fn test_hello_method() {
    ...
    assert_eq!(
        r2s(|o| templates::hello_method_html(o, &user)),
        "<h1>Hello Tom Puss!</h1>\n<p>Your email is \
...
fn test_hello_code() {
    use templates::Html;
    assert_eq!(
        r2s(|o| templates::hello_code_html(
            o,
            &"Paragraph:",
            &Html("<p>Hello.</p>")
        )),
...
fn test_for_loop() {
    assert_eq!(
        r2s(|o| templates::for_loop_html(o, &vec!["Hello", "World"])),
...
fn test_for_destructure() {
    ...
    assert_eq!(
        r2s(|o| templates::for_destructure_html(o, &users)),
...
fn test_explicit_formatting() {
    assert_eq!(
        r2s(|o| templates::explicit_formatting_html(
            o,
            5.212432234,
            "one\ntwo"
        )),
...
fn test_hello_use_templates() {
    use crate::templates::Html;
    assert_eq!(
        r2s(|o| templates::hello_use_templates_html(
            o,
            &Html("<p>this is foo</p>")
        )),
        "<h1>Hello World!</h1>\
         \n<p>Note: Brackets and @ signs needs to be escaped: { ... }</p>\n\
         \n<h2>foo</h2>\n<p>this is foo</p>\n\n"
...
fn test_some_expressions() {
    assert_eq!(
        r2s(|o| templates::some_expressions_html(o, "name")),
        "<p>name</p>\
         \n<p>name.name</p>\
         \n<p>4</p>\
         \n<p>name.len()</p>\
...
#[test]
fn test_issue_66() {
    assert_eq!(r2s(|o| templates::issue_66_html(o)), "ABC\n");
}

#[test]
fn test_issue_68() {
    assert_eq!(
        r2s(|o| templates::issue_68_html(o)),
        "Hello!\n\nThe 0 number.\n\nThe 1 number.\n\nThe 2 number.\n\nGood bye!\n",
    );
}
...
fn lifetimes() {
    assert_eq!(
        r2s(|o| templates::with_lifetime_html(o, &["foo", "bar"])),
        "\n  <p>foo</p>\n\n  <p>bar</p>\n\n",
    );
}
...
fn lifetimes2() {
    assert_eq!(
        r2s(|o| templates::with_lifetime2_html(o, &["foo", "bar"])),
        "\n  <p>foo</p>\n\n  <p>bar</p>\n\n",
    );
}
